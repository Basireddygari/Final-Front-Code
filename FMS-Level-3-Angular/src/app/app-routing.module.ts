...
//import { search} from './search/Serarch.component';
import { SerarchComponent } from './search/search.component'; 
...
import { PnrBookingComponent } from './pnr-booking/pnr-booking.component';
...
const routes: Routes = [
  ...
  {path: 'email', component: EmailBookingComponent},
  ...
  {path: 'deleteBooking',component: CancelBookingComponent},
  ...
  {path: 'pnrr', component:PnrBookingComponent}
